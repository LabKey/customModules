...
CAST(IFDEFINED(FCSAnalyses.FCSFile.Sample.Property.SPECTYPE) AS VARCHAR) AS SPECTYPE,
CAST(IFDEFINED(FCSAnalyses.FCSFile.Sample.Property.ISOLATION) AS VARCHAR) AS ISOLATION,
CAST(IFDEFINED(FCSAnalyses.FCSFile.Sample.Property.ADDITIVE) AS VARCHAR) AS ADDITIVE,
CAST(IFDEFINED(FCSAnalyses.FCSFile.Sample.Property.CRYOSTAT) AS VARCHAR) AS CRYOSTAT,
