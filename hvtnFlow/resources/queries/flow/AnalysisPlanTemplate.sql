...
A.ADDITIVE,
A.CRYOSTAT,
-- Ticket 41853: New analysis plan 052: pull CTRSAMPNAME through the sample set
CASE
  WHEN IFDEFINED(A._fcsfile.Keyword.CTRSAMPNAME) IS NOT NULL THEN IFDEFINED(A._fcsfile.Keyword.CTRSAMPNAME)
  WHEN A.SPECROLE = 'QC' THEN A.PTID
  ELSE NULL
END AS CTRSAMPNAME,
A.STDY_DESC,
A.VISITNO,
