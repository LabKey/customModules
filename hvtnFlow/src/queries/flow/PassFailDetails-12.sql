...
(
  SELECT A.RowId,
    ...
    A.Statistic('S/Exclude/Lv/14-/L/3+/4+:Count') AS CD4_Count,
    A.Statistic('S/Exclude/Lv/14-/L/3+/4+/IL2+:Count') AS CD4_IL2_Count,
    A.Statistic('S/Exclude/Lv/14-/L/3+/4+/IFNg+:Count') AS CD4_IFNg_Count,
    A.Statistic('S/Exclude/Lv/14-/L/3+/4+/154+:Count') AS CD4_CD154_Count,
    A.Statistic('S/Exclude/Lv/14-/L/3+/4+/TNFa+:Count') AS CD4_TNFa_Count,
    A.Statistic('S/Exclude/Lv/14-/L/3+/4+/IL2+:Freq_Of_Parent') AS CD4_IL2_Freq,
    A.Statistic('S/Exclude/Lv/14-/L/3+/4+/IFNg+:Freq_Of_Parent') AS CD4_IFNg_Freq,
    A.Statistic('S/Exclude/Lv/14-/L/3+/4+/154+:Freq_Of_Parent') AS CD4_CD154_Freq,
    A.Statistic('S/Exclude/Lv/14-/L/3+/4+/TNFa+:Freq_Of_Parent') AS CD4_TNFa_Freq,

    A.Statistic('S/Exclude/Lv/14-/L/3+/8+:Count') AS CD8_Count,
    A.Statistic('S/Exclude/Lv/14-/L/3+/8+/IL2+:Count') AS CD8_IL2_Count,
    A.Statistic('S/Exclude/Lv/14-/L/3+/8+/IFNg+:Count') AS CD8_IFNg_Count,
    A.Statistic('S/Exclude/Lv/14-/L/3+/8+/154+:Count') AS CD8_CD154_Count,
    A.Statistic('S/Exclude/Lv/14-/L/3+/8+/TNFa+:Count') AS CD8_TNFa_Count,
    A.Statistic('S/Exclude/Lv/14-/L/3+/8+/IL2+:Freq_Of_Parent') AS CD8_IL2_Freq,
    A.Statistic('S/Exclude/Lv/14-/L/3+/8+/IFNg+:Freq_Of_Parent') AS CD8_IFNg_Freq,
    A.Statistic('S/Exclude/Lv/14-/L/3+/8+/154+:Freq_Of_Parent') AS CD8_CD154_Freq,
    A.Statistic('S/Exclude/Lv/14-/L/3+/8+/TNFa+:Freq_Of_Parent') AS CD8_TNFa_Freq,
