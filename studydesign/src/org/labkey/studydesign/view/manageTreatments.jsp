...
<div style="width: 1400px;">
    <ul>
        ...
        <li>
            ...
            <%=link("Manage Cohorts", PageFlowUtil.urlProvider(StudyUrls.class).getManageCohortsURL(getContainer()))%>
        </li>
        <li>
            ...
            <%=link("Manage " + visitNoun + "s", PageFlowUtil.urlProvider(StudyUrls.class).getManageVisitsURL(getContainer()))%>
        </li>
<%
    if (canManageStudy)
    {
...
%>
            ...
            <%= link("Change Visit Order", PageFlowUtil.urlProvider(StudyUrls.class).getVisitOrderURL(c).addReturnUrl(getActionURL())) %>
            </li>
<%
        }
    }
