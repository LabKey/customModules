...
public class ImmunizationScheduleWebpartFactory extends StudyDesignWebpartFactory
{
    ...
    public WebPartView<?> getWebPartView(@NotNull ViewContext portalCtx, @NotNull Portal.WebPart webPart)
    {
        ...
        JspView<Portal.WebPart> view = new JspView<>("/org/labkey/studydesign/view/immunizationScheduleWebpart.jsp", webPart);
        view.setTitle(NAME);
        ...
        if (c.hasPermission(portalCtx.getUser(), ManageStudyPermission.class))
        {
            ...
            menu.addChild("Manage Cohorts", PageFlowUtil.urlProvider(StudyUrls.class).getManageCohortsURL(c));
