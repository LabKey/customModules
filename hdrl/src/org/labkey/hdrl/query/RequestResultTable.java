 ...
 */
public class RequestResultTable extends SimpleUserSchema.SimpleTable<HDRLQuerySchema>
{
    public RequestResultTable(@NotNull HDRLQuerySchema schema)
    {
        super(schema, schema.getDbSchema().getTable(schema.TABLE_REQUEST_RESULT));
    }
